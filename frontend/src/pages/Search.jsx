...
import backgroundImage from "../assets/img2.jpg"; // put your image here
...
const Search = () => {
  ...
  // open item and track search if user is logged in
  ...
  return (
    ...
    >
      ...
      {error && (
        <p style={{ color: "red", textAlign: "center", marginBottom: "1rem" }}>Error: {error}</p>
      )}
